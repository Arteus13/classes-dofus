            ...
            <div className="details-layout">
              ...
              <div className="right-column">
                <div className="skins-wrapper">
                  <h3 className="skins-title">Skins</h3> 
                    ...
                    <>
                      ...
                      <button className="btn-details" onClick={() => window.open(`https://barbofus.com/unity-skins?classe=${selectedClass.id}`, "_blank")}> Skins disponibles </button>
                    </>
                  ) : (
