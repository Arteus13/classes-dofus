...
function App() {
  ...
  const goToNextClass = () => {
    ...
    const nextIndex = (currentIndex + 1) % classData.length
    setOpenSort(null)
    setSelectedClass(classData[nextIndex])
  }

  const goToPreviousClass = () => {
    const currentIndex = classData.findIndex(c => c.id === selectedClass.id)
    const prevIndex = (currentIndex - 1 + classData.length) % classData.length
    setOpenSort(null)
    setSelectedClass(classData[prevIndex])
  }
      ...
      {selectedClass && (
        <div className='modal-overlay' onClick={closeModal}>
          <div className="nav-arrows"onClick={(e) => e.stopPropagation()}>
              <img
                src="/assets/fleche/fleche_gauche.png"
                alt="Précédent"
              ...
              <img
                src="/assets/fleche/fleche_droite.png"
                alt="Suivant"
          ...
          <div className='details-panel' onClick={(e) => e.stopPropagation()}>
            ...
            <h2>{selectedClass.nom} - Sort Principaux </h2>
            ...
            <div className="details-layout">
                ...
                {selectedClass.sorts_principaux?.map((sort, index) => (
                  ...
                  >
                    ...
                    <div className="sort-details">
                      <p><strong>Cout PA : </strong>{sort.cout_pa}</p>
              ...
              <div className="right-column">
                ...
                {selectedClass.skins && selectedClass.skins.length > 0 ? (
